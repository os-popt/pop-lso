...
function f=ftabletrot(x)
  ...
  f = ftablet(ORTHOGONALCOORSYSTEM_G{N}*x);  
  
function f=fcigarrot(x)
  N = size(x,1);
  global ORTHOGONALCOORSYSTEM_G
  if isempty(ORTHOGONALCOORSYSTEM_G) ...
	|| length(ORTHOGONALCOORSYSTEM_G) < N ...
  ...
  f = fcigar(ORTHOGONALCOORSYSTEM_G{N}*x);  
  
function f=fdiffpowrot(x)
  N = size(x,1);
  global ORTHOGONALCOORSYSTEM_G
  if isempty(ORTHOGONALCOORSYSTEM_G) ...
	|| length(ORTHOGONALCOORSYSTEM_G) < N ...
  ...
  f = fdiffpow(ORTHOGONALCOORSYSTEM_G{N}*x);    
...
function f=fdiffpow(x)
  ...
  f = sum(abs(x).^repmat(2+4*(0:N-1)'/(N-1), 1, popsi), 1);
%  f = sqrt(f); 
